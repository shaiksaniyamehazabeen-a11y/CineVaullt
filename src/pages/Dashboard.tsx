...
function Dashboard() {
  ...
  const lastRefreshed = useRef(new Date().toLocaleTimeString());

  // Calculate dashboard statistics
  const statistics = useMemo(() => {
    const watched = savedItems.filter(
      (movie) => movie.status === "watched"
    ).length;

    const watching = savedItems.filter(
  ...
  // Display the five most recently saved movies
        ...
        <div className="dashboard-header">
          ...
          <div className="dashboard-heading">
            ...
            <p className="dashboard-subtitle">
              Track your saved movies and discover something new.
            </p>
